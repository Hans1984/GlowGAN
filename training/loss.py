...
class Loss:
    def accumulate_gradients(self, phase, real_img, real_c, gen_z, gen_c, gen_e, gen_gamma, gen_beta, gain, cur_nimg): # to be overridden by subclass
...
class ProjectedGANLoss(Loss):
    ...
    def run_G(self, z, c, e, gamma, beta, update_emas=False):
        ...
        img = self.G.synthesis(ws, e, gamma, beta, update_emas=False)  # enabling emas leads to collapse with PG
        return img, ws
    ...
    def accumulate_gradients(self, phase, real_img, real_c, gen_z, gen_c, gen_e, gen_gamma, gen_beta, gain, cur_nimg):
        ...
        if do_Gmain:
            ...
            with torch.autograd.profiler.record_function('Gmain_forward'):
                gen_img, _gen_ws = self.run_G(gen_z, gen_c, gen_e, gen_gamma, gen_beta)
        ...
        if start_plreg and self.pl_weight and phase in ['Greg', 'Gboth']:
            with torch.autograd.profiler.record_function('Gpl_forward'):
                ...
                gen_img, gen_ws = self.run_G(gen_z[:batch_size], gen_c[:batch_size], gen_e[:batch_size], gen_gamma[:batch_size], gen_beta[:batch_size])
        ...
        if do_Dmain:
            with torch.autograd.profiler.record_function('Dgen_forward'):
                gen_img, _gen_ws = self.run_G(gen_z, gen_c, gen_e, gen_gamma, gen_beta, update_emas=True)
                gen_logits = self.run_D(gen_img, gen_c, blur_sigma=blur_sigma)
